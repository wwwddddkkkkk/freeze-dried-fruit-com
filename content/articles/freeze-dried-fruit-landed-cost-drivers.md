---
title: "What Actually Drives Freeze-Dried Fruit Landed Cost"
category: "Industry Insights"
date: 2026-05-13
read: "7 min read"
summary: "The quoted case price is only the starting point. Yield, breakage, packaging, freight, and spec discipline usually decide the real landed cost."
intro: "Two freeze-dried fruit quotes can look close on paper and still land at very different real costs once yield, spec tolerance, and logistics are counted."
takeaways:
...
1. Quote price by delivered format.
2. Record expected dry yield or format yield assumptions.
3. Record usable yield after breakage and screening.
4. Add packaging and freight costs.
5. Add duties, handling, and warehouse assumptions.
6. Convert the result into cost per usable kilogram or cost per sellable serving.
