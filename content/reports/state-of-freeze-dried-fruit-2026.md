...
sections:
  ...
  - id: category-at-a-glance
    title: "1. The category at a glance"
  - id: supply-origins
    title: "2. Supply origins and concentration"
  - id: consumer-trends
    title: "3. Consumer trends"
  - id: technology-shifts
    title: "4. Technology and process shifts"
  - id: regulation-and-quality
    title: "5. Regulation, certification, and quality"
  - id: pricing-and-landed-cost
    title: "6. Pricing and landed cost"
  - id: outlook
    title: "7. Outlook — what to watch through 2027"
takeaways:
...
sources:
  - title: "Food Safety Modernization Act (FSMA)"
    ...
    note: "Federal preventive-controls framework that defines supplier verification expectations for every fruit ingredient buyer."
  - title: "Foreign Supplier Verification Programs (FSVP)"
    ...
    publisher: "U.S. Food & Drug Administration"
    note: "Directly applicable to fruit imported from China, Chile, Peru, and other major origins — the regulatory baseline for cross-border buying."
  - title: "Labeling Organic Products"
    ...
    note: "Defines the four U.S. organic labeling tiers — the framework most retailers reference when reviewing freeze-dried fruit organic claims."
  - title: "Added Sugars on the Nutrition Facts Label"
    ...
    publisher: "U.S. Food & Drug Administration"
    note: "The federal rule that requires the 'Includes Xg Added Sugars' line — directly relevant to sweetened freeze-dried fruit positioning."
  - title: "Water Activity (aw) in Foods — Inspection Technical Guide"
    ...
    publisher: "U.S. Food & Drug Administration"
    note: "FDA's reference for how residual moisture and water activity control microbial and chemical stability in finished foods."
  - title: "Global Food Safety Initiative (GFSI) Recognized Programs"
  ...
  - title: "USDA Agricultural Trade Data — Fresh & Processed Fruit"
    url: "https://www.fas.usda.gov/data"
    publisher: "USDA Foreign Agricultural Service"
    note: "Source for import/export volume tracking on the raw fruit underlying U.S. freeze-dried supply."
  - title: "Freeze Drying of Foods — Engineering Principles"
    ...
    note: "Peer-reviewed reference on lyophilization heat and mass transfer — the engineering behind cycle-time decisions made daily on plant floors."
  - title: "Dietary Guidelines for Americans 2020-2025"
    ...
    note: "The federal framework on added sugar limits — context for the clean-label reformulation pressure pulling at sweetened freeze-dried fruit SKUs."
---
...
- **Sweetened freeze-dried crisps** are a legitimate category but should not be marketed as nutritionally equivalent — the FDA's [Added Sugars rule](https://www.fda.gov/food/nutrition-facts-label/added-sugars-nutrition-facts-label) now requires disclosure that makes the difference visible to shoppers.
...
The most defensive buyers in 2026 are running dual-origin supply where possible (e.g., Chinese plus Chilean blueberry), with documented backup suppliers under [FSVP](https://www.fda.gov/food/food-safety-modernization-act-fsma/fsma-final-rule-foreign-supplier-verification-programs-fsvp-importers-food-humans-and-animals) — even when it costs slightly more on the unit-price line.

## 3. Consumer trends {#consumer-trends}
...
First, the FDA's [Added Sugars line](https://www.fda.gov/food/nutrition-facts-label/added-sugars-nutrition-facts-label) on the Nutrition Facts panel makes the difference visible. A sweetened "fruit crisp" can carry 6–10g added sugar per serving; a plain freeze-dried strawberry carries zero. Shoppers reading the panel side-by-side notice.

Second, the [Dietary Guidelines for Americans 2020-2025](https://www.dietaryguidelines.gov/sites/default/files/2020-12/Dietary_Guidelines_for_Americans_2020-2025.pdf) recommend added sugars stay below 10% of daily calories — and a meaningful fraction of consumers are now actively tracking this.
...
There has been no revolutionary change in freeze-drying chemistry in 2026. The underlying lyophilization process — freeze, vacuum, sublimate, secondary-dry — is the same one [described in IFT's peer-reviewed engineering reference](https://ift.onlinelibrary.wiley.com/doi/10.1111/j.1750-3841.2009.01138.x) a decade ago.
...
- More routine use of [residual oxygen monitoring](https://www.fda.gov/inspections-compliance-enforcement-and-criminal-investigations/inspection-references/reduced-oxygen-packaging-rop) for nitrogen-flushed packs
...
For U.S. buyers importing freeze-dried fruit, the [Foreign Supplier Verification Programs (FSVP) rule](https://www.fda.gov/food/food-safety-modernization-act-fsma/fsma-final-rule-foreign-supplier-verification-programs-fsvp-importers-food-humans-and-animals) is no longer optional. Every importer must document hazard analysis, supplier verification activities, and corrective-action procedures for every supplier-fruit combination they bring across the border. The documentation burden alone has pushed smaller importers to consolidate suppliers or to outsource FSVP compliance.

For domestic operations, the broader [FSMA Preventive Controls for Human Food rule](https://www.fda.gov/food/food-safety-modernization-act-fsma/fsma-final-rule-preventive-controls-human-food) defines hazard analysis, sanitary preventive controls, supply chain controls, and recall plan expectations.

### GFSI-recognized certifications

The de-facto baseline for selling freeze-dried fruit into large retailers, restaurant chains, and major brand buyers is a [GFSI-recognized certification](https://mygfsi.com/how-to-implement/recognition/) — most commonly SQF, BRCGS, or FSSC 22000. A supplier without one of these certifications is increasingly difficult to onboard at any meaningful scale.

### Organic verification

[USDA's National Organic Program](https://www.ams.usda.gov/about-ams/programs-offices/national-organic-program) labeling tiers remain the U.S. federal standard. The two practical pressure points in 2026 are:
...
The most contested labeling category is **fruit-equivalent claims** — "made from two cups of fruit," "X% real fruit," and similar. These claims sit inside the [FDA Food Labeling Guide](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-food-labeling-guide) framework but are not always reviewed in detail before launch. Brands that overreach on these claims are seeing them flagged by retailer quality teams more often than they were two years ago.
