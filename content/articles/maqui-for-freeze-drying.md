---
title: "A Field Guide to Maqui for Freeze-Drying"
...
faqs:
  - q: "What is maqui?"
    a: "Maqui (Aristotelia chilensis) is a small dark-purple berry from a wild evergreen tree native to the temperate rainforests of southern Chile and parts of Argentina. The Mapuche people have used maqui as food and medicine for centuries; commercial export only began at meaningful scale in the last 20 years."
  - q: "Why is maqui marketed as a superfruit?"
    a: "Maqui has one of the highest measured anthocyanin and ORAC (antioxidant capacity) values of any commercial fruit — typically several times that of blueberry. This makes it a popular ingredient in supplement and antioxidant-positioned products. Specific health claims are regulated and vary by market; verify against your jurisdiction's labeling rules."
  - q: "Where is maqui grown?"
    a: "Almost all commercial maqui is wild-harvested or semi-cultivated in the temperate rainforests of southern Chile, particularly in the Araucanía and Los Lagos regions of Patagonia. Argentina has small additional production. There is no industrial-scale maqui cultivation outside this region."
  - q: "Why is freeze-dried maqui mostly sold as powder?"
    a: "The berries are tiny — typically 4–6mm — and their value is concentrated in pigment and antioxidant content rather than visible piece identity. Freeze-dried whole maqui exists, but the dominant commercial format is powder for supplement formulation, smoothie blends, and natural-color applications."
  - q: "What does freeze-dried maqui taste like?"
    a: "Mild, mildly tart, slightly astringent. Maqui has a much less intense flavor than its color suggests — most consumers describe it as a quiet berry note rather than a bold flavor. This is why maqui is usually a functional or color ingredient rather than a flavor ingredient."
  - q: "How is wild-harvested maqui different from cultivated berries?"
    a: "Wild harvest creates supply variability — harvest yields depend on weather, forest access, and Mapuche community-based gathering practices. This affects pricing and lot-to-lot consistency. Some growing operations are now attempting semi-cultivation, which may stabilize supply over time."
  - q: "What should buyers ask suppliers about freeze-dried maqui?"
    a: "Confirm origin (specifically the region in Chilean Patagonia), wild-harvest vs. cultivated status, fair-trade or community-sourcing certifications when applicable, whether the powder is pure maqui or carrier-blended, target anthocyanin content (some lots are sold with measured anthocyanin specifications), and microbiological standards."
sources:
  - title: "Aristotelia chilensis — Botanical and Compositional Reference"
    url: "https://www.feedipedia.org/"
    publisher: "Feedipedia (CIRAD / INRAE / AFZ / FAO)"
    note: "Reference for botanical, agronomic, and compositional data on maqui."
  - title: "Anthocyanin and Antioxidant Capacity of Maqui Berry"
    ...
    note: "Peer-reviewed analysis of anthocyanin chemistry in maqui and related berries."
  - title: "Chile Forestry Service — Wild Harvest Standards"
    url: "https://www.conaf.cl/"
    publisher: "CONAF (Corporación Nacional Forestal de Chile)"
    note: "Chilean government agency that oversees wild harvest of native species, including maqui in Patagonian forests."
---
