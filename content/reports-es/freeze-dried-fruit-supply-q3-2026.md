...
sections:
  - id: snapshot
    title: "Resumen Q3"
  - id: berry-peak
    title: "1. Pico de bayas del hemisferio norte"
  - id: late-season-mango
    title: "2. Mango de fin de temporada"
  - id: stone-fruit
    title: "3. Fruta de hueso y pomáceas"
  - id: pricing
    title: "4. Señales de precio y flete"
  - id: q4-outlook
    title: "5. Perspectiva Q4"
takeaways:
...
sources:
  - title: "USDA Foreign Agricultural Service — Datos de Producción"
    url: "https://www.fas.usda.gov/data"
    publisher: "USDA Foreign Agricultural Service"
    note: "Datos de producción y exportación de EE. UU. para bayas del hemisferio norte, fruta de hueso e importaciones de mango de fin de temporada."
  - title: "Producción de Bayas Europea — Eurostat"
    url: "https://ec.europa.eu/eurostat"
    publisher: "Eurostat — Oficina Estadística Europea"
    note: "Datos europeos de producción de bayas, incluyendo volúmenes de procesamiento polaco, serbio y español que suministran las importaciones de fruta liofilizada de la UE y EE. UU."
  - title: "Ley de Modernización de la Seguridad Alimentaria (FSMA) — Controles Preventivos"
    ...
    note: "Marco FSMA para instalaciones de procesamiento de EE. UU. que manejan volumen pico de fruta del hemisferio norte en el Q3."
  - title: "Mexican Mango Promotion Board"
    url: "https://www.mango.org/"
    publisher: "National Mango Board (USA) / Productores mexicanos"
    note: "Datos de referencia para las ventanas de producción de mango Ataulfo, Kent y Keitt mexicanos."
---
