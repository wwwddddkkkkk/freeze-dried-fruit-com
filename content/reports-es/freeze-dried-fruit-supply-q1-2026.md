---
slug: freeze-dried-fruit-supply-q1-2026
en_slug: freeze-dried-fruit-supply-q1-2026
title: "Nota de suministro de fruta liofilizada — Q1 2026"
subtitle: "Pico del hemisferio sur, pretemporada de mango premium y qué deben los compradores asegurar antes del Q2."
date: 2026-03-31
updated: 2026-03-31
...
sections:
  ...
  - id: southern-hemisphere
    title: "1. Pico del hemisferio sur"
  - id: northern-hemisphere
    title: "2. Hemisferio norte fuera de temporada"
  - id: pricing
    title: "3. Señales de precio y flete"
  - id: q2-outlook
    title: "4. Perspectiva Q2"
takeaways:
...
sources:
  - title: "Chile — Datos de Exportaciones Agrícolas"
    url: "https://www.odepa.gob.cl/"
    publisher: "ODEPA — Oficina de Estudios y Políticas Agrarias (Chile)"
    note: "Datos oficiales agrícolas chilenos para arándano, frambuesa, cereza y volúmenes de exportación de fruta andina especial."
  - title: "Perú — Estadísticas de Comercio Agrícola"
    url: "https://www.gob.pe/midagri"
    publisher: "Ministerio de Desarrollo Agrario y Riego (Perú)"
    note: "Datos oficiales peruanos de comercio agrícola para mango, arándano y exportación de fruta andina especial."
  - title: "USDA Foreign Agricultural Service — Comercio global de fruta"
    url: "https://www.fas.usda.gov/data"
    publisher: "USDA Foreign Agricultural Service"
    note: "Datos comprensivos de importación/exportación de fruta fresca y procesada relevantes para los compradores estadounidenses de fruta liofilizada."
  - title: "Programa de Verificación de Proveedores Extranjeros (FSVP)"
    ...
    note: "Marco FSVP aplicable a todas las importaciones estadounidenses desde Chile, Perú y otros orígenes pico Q1 del hemisferio sur."
---
...
1. **Reducción de inventario IQF.** La fresa, frambuesa y mora mexicana, polaca, serbia y española procesadas en la temporada pico 2025 se están reduciendo durante el Q1. Los compradores deben pedir a los proveedores la fecha de congelación IQF — el inventario más viejo puede mostrar degradación de textura o aroma.

2. **Producción mediterránea de invernadero.** La producción de fresa marroquí y del sur de España extiende la disponibilidad invernal, aunque los volúmenes son limitados.

3. **Abastecimiento entre hemisferios.** El producto chileno de bayas llena el espacio del estante del hemisferio norte durante el Q1, con el nivel premium moviéndose a través de canales especializados.
